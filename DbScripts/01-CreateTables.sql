...
CREATE TABLE EVENTO(
	...
	ID_PROVINCIA INT, 
	DIRECCION VARCHAR(100) DEFAULT 'A confirmar',
...
CREATE TABLE CREDENCIALES(
	...
	CONSTRAINT FK_CREDENCIALES_ORGANIZADOR
		FOREIGN KEY(ID) REFERENCES ORGANIZADOR(ID_ORGANIZADOR),
	CONSTRAINT FK_CREDENCIALES_PROVEEDOR 
		FOREIGN KEY(ID) REFERENCES PROVEEDOR(ID_PROVEEDOR)
);

CREATE TABLE PAGO(
	ID_PAGO UNIQUEIDENTIFIER DEFAULT NEWID(),
	ID_EVENTO UNIQUEIDENTIFIER NOT NULL, --FK
	ID_PROVEEDOR UNIQUEIDENTIFIER NOT NULL, --FK
	ID_SERVICIO INT NOT NULL, --FK
	FECHA_PAGO DATETIME NOT NULL, 
	MONTO DECIMAL(10,2),
	CONSTRAINT PK_PAGO PRIMARY KEY(ID_EVENTO,ID_PROVEEDOR,ID_SERVICIO),
